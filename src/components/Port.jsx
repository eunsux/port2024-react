...
//                         <a href="https://github.com/kimsangjunv1/-React-Portfolio" target="_blank" className="img" rel="noreferrer">
//                             <img src="../assets/img/port01.jpg" alt="김상* 포트폴리오" />
//                         </a>
...
//                         </p>
//                         <a href="https://portfoliosj-react.netlify.app/" target="_blank" className="site" rel="noreferrer">사이트 보기</a>
//                     </article>

//                     <article className="port__item p2">
//                         <span className="num">02.</span>
//                         <a href="https://github.com/seolhee313/PORTFOLIO-REACT" className="img" target="_blank" rel="noreferrer">
//                             <img src="../assets/img/port02.jpg" alt="천설* 포트폴리오" />
//                         </a>
...
//                         </p>
//                         <a href="https://portfolio-313.web.app/" target="_blank" className="site" rel="noreferrer">사이트 보기</a>
//                     </article>

//                     <article className="port__item p3">
//                         <span className="num">03.</span>
//                         <a href="https://github.com/YeoDaSeul4355/portfolio" className="img" target="_blank" rel="noreferrer">
//                             <img src="../assets/img/port03.jpg" alt="여다* 포트폴리오" />
//                         </a>
...
//                         </p>
//                         <a href="https://portfolio-jjul.web.app/" target="_blank" className="site" rel="noreferrer">사이트 보기</a>
//                     </article>

//                     <article className="port__item p4">
//                         <span className="num">04.</span>
//                         <a href="https://github.com/dlgnsrb227/portfolio-next" className="img" target="_blank" rel="noreferrer">
//                             <img src="../assets/img/port04.jpg" alt="이훈* 포트폴리오" />
//                         </a>
//                         <h3 className="title">모던한 포트폴리오</h3>
//                         <p className="desc">
//                             블랙 컨셉과 애니메이션이 돋보이는 포트폴리오 사이트입니다.
//                             GSAP를 통한 애니메이션과 NEXT.js를 통해 제작된 포트폴리오입니다.
//                             pin 애니메이션을 통한 포폴 작업물의 표현 능력이 돋보이는 사이트입니다.
//                         </p>
//                         <a href="https://hoongportfolio-next.netlify.app/" target="_blank" className="site" rel="noreferrer">사이트 보기</a>
//                     </article>

//                     <article className="port__item p5">
//                         <span className="num">05.</span>
//                         <a href="/" className="img" target="_blank">
//                             <img src="../assets/img/port05.jpg" alt="박준* 포트폴리오" />
//                         </a>
//                         <h3 className="title">가로모드의 정석 포트폴리오</h3>
//                         <p className="desc">
...
//                         </p>
//                         <a href="https://junseungpark.github.io/portfolio/index3.html" target="_blank" className="site" rel="noreferrer">사이트 보기</a>
//                     </article>

//                     <article className="port__item p6">
//                         <span className="num">06.</span>
//                         <a href="/" className="img" target="_blank">
//                             <img src="../assets/img/port06.jpg" alt="포트폴리오" />
//                         </a>
//                         <h3 className="title">화려함의 정석 포트폴리오</h3>
//                         <p className="desc">
...
//                         </p>
//                         <a href="https://webstoryboy.github.io/port2023/portfolio-student/DavidYang/index.html" target="_blank" className="site" rel="noreferrer">사이트 보기</a>
//                     </article>

//                     <article className="port__item p7">
//                         <span className="num">07.</span>
//                         <a href="/" className="img" target="_blank">
//                             <img src="../assets/img/port07.jpg" alt="포트폴리오" />
//                         </a>
//                         <h3 className="title">패럴랙스 정석 포트폴리오</h3>
//                         <p className="desc">
...
//                         </p>
//                         <a href="https://webstoryboy.github.io/port2023/portfolio-student/TaeyongLee/index.html" target="_blank" className="site" rel="noreferrer">사이트 보기</a>
//                     </article>

//                     <article className="port__item p8">
//                         <span className="num">08.</span>
//                         <a href="/" className="img" target="_blank">
//                             <img src="../assets/img/port08.jpg" alt="김현로 포트폴리오" />
//                         </a>
//                         <h3 className="title">트랜지션 포트폴리오</h3>
//                         <p className="desc">
...
//                         </p>
//                         <a href="https://webstoryboy.github.io/port2023/portfolio-student/HyunroKim/index.html" target="_blank" className="site" rel="noreferrer">사이트 보기</a>
//                     </article>

//                     <article className="port__item p9">
//                         <span className="num">09.</span>
//                         <a href="/" className="img" target="_blank">
//                             <img src="../assets/img/port09.jpg" alt="포트폴리오" />
//                         </a>
//                         <h3 className="title">스크롤의 정석 포트폴리오</h3>
//                         <p className="desc">
...
//                         </p>
//                         <a href="https://webstoryboy.github.io/port2023/portfolio-student/ChoJaeHyung/index.html" target="_blank" className="site" rel="noreferrer">사이트 보기</a>
//                     </article>

//                     <article className="port__item p10">
//                         <span className="num">10.</span>
//                         <a href="/" className="img" target="_blank"> 
//                             <img src="../assets/img/port10.jpg" alt="포트폴리오" />
//                         </a>
//                         <h3 className="title">모던함의 정석 포트폴리오</h3>
//                         <p className="desc">
...
//                         </p>
//                         <a href="https://webstoryboy.github.io/port2023/portfolio-student/JooHyeji/index.html" target="_blank" className="site" rel="noreferrer">사이트 보기</a>
//                     </article>
//                 </div>
//             </div>
//         </section>
